namespace Shared.EventStore
{
    ...
    public class EventStoreContext : IEventStoreContext
    {
                                                ...
                                                Int32 bufferSize)
        {
            ...
            Guard.ThrowIfInvalidGuid(subscriptionGroupId,
                                     typeof(ArgumentNullException),
                                     "Subscription Group Id cannot be an empty GUID when connecting to a Subscription");
                                                        ...
                                                        PersistentSubscriptionSettings persistentSubscriptionSettings)
        {
            ...
            Guard.ThrowIfNull(persistentSubscriptionSettings,
                              typeof(ArgumentNullException),
                              "Persistent Subscription Settings cannot be null when creating a Persistent Subscription");
